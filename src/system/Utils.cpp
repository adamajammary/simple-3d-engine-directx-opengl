...
const uint8_t  Utils::APP_VERSION_PATCH  = 3;
const wxString Utils::APP_VERSION        = "1.0.3";
const wxString Utils::ASPECT_RATIOS[]    = { "16:9", "4:3" };
const wxChar*  Utils::BOUNDING_VOLUMES[] = { wxT("None"), wxT("Box (AABB)"), wxT("Box (OBB)"), wxT("Sphere"), nullptr };
